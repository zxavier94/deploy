...
public class SftpUtil {
     ...
     */
    public ChannelSftp getSftpConnect(final String host, final int port, final String username,
    ...
    private static void exeRmRec(final String pathString, final ChannelSftp sftp) throws SftpException {
        @SuppressWarnings("unchecked") Vector<LsEntry> vector = sftp.ls(pathString);
     ...
     * @param sftp sftp连接
     */
    public static void exit(ChannelSftp sftp) {
        sftp.exit();
        sftp.disconnect();
    }
